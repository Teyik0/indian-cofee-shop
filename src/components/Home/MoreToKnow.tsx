...
const buttonStyle = `rounded-xl w-1/2 mt-12 pl-8 pr-8 pt-4 pb-4 bg-white text-black 
    ...
    <section className='pt-12 pb-12 sm:p-12 flex flex-col justify-center items-center'>
      <div className='flex flex-col sm:flex-row justify-center items-center sm:flex-wrap gap-8'>
        <div className={rectStyle}>
          ...
          <Link href='/menu' className={buttonStyle}>
            Cliquez ici
          </Link>
        </div>
        ...
        <div className={rectStyle}>
          ...
          <Link href='/galerie' className={buttonStyle}>
            Cliquez ici
          </Link>
        </div>
